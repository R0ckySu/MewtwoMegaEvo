...
void MewHamiltonianTable::reindexing_table_cells() {
...
StaticHamiltonianCell::StaticHamiltonianCell(MewHamiltonianTable& parent_table) : HamiltonianCell() {
...
void StaticHamiltonianCell::loadInfoFromJson(Wt::Json::Object dict) {
...
Wt::Json::Object StaticHamiltonianCell::getJsonObj() {
...
MWHamiltonianCell::MWHamiltonianCell(MewHamiltonianTable& parent_table) : HamiltonianCell() {
...
void MWHamiltonianCell::loadInfoFromJson(Wt::Json::Object dict) {
    tag->set_data(dict.get(std::string(tag->get_data().first)));
    enable->set_data(dict.get(std::string(enable->get_data().first)));
    amplitude->set_data(dict.get(std::string(amplitude->get_data().first)));
...
Wt::Json::Object MWHamiltonianCell::getJsonObj() {
    Wt::Json::Object h = Wt::Json::Object();
    h.insert(tag->get_data());
...
AWGHamiltonianCell::AWGHamiltonianCell(MewHamiltonianTable& parent_table) : HamiltonianCell() {
...
void AWGHamiltonianCell::loadInfoFromJson(Wt::Json::Object dict) {
    tag->set_data(dict.get(std::string(tag->get_data().first)));
    enable->set_data(dict.get(std::string(enable->get_data().first)));
    amplitude->set_data(dict.get(std::string(amplitude->get_data().first)));
    rising_time->set_data(dict.get(std::string(rising_time->get_data().first)));
...
Wt::Json::Object AWGHamiltonianCell::getJsonObj() {
    Wt::Json::Object h = Wt::Json::Object();
    h.insert(tag->get_data());
...
NoiseHamiltonianCell::NoiseHamiltonianCell(MewHamiltonianTable& parent_table) : HamiltonianCell() {
...
void NoiseHamiltonianCell::loadInfoFromJson(Wt::Json::Object dict) {
    tag->set_data(dict.get(std::string(tag->get_data().first)));
    enable->set_data(dict.get(std::string(enable->get_data().first)));
    amplitude->set_data(dict.get(std::string(amplitude->get_data().first)));
    h_pauli_mat->set_data(dict.get(std::string(h_pauli_mat->get_data().first)));
...
Wt::Json::Object NoiseHamiltonianCell::getJsonObj() {
    Wt::Json::Object h = Wt::Json::Object();
    h.insert(tag->get_data());
...
MewHamiltonianConfig::MewHamiltonianConfig() : Wt::WContainerWidget() {
...
void MewHamiltonianConfig::load_from_file(std::string filePath) {
