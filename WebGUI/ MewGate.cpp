...
void MewGateTable::reindexing_table_cells() {
...
GateCell::GateCell(MewGateTable& parent_table) : BaseGateCell() {
...
void GateCell::loadInfoFromJson(Wt::Json::Object dict) {
...
Wt::Json::Object GateCell::getJsonObj() {
...
MewGateConfig::MewGateConfig(): Wt::WContainerWidget() {
...
void MewGateConfig::load_from_file(std::string filePath) {
