...
export EX_FOLDER="/scratch/oz09/ys2525/MewtwoMegaEvo/Playground/sim_results/"
export CONFIG_PATH="/scratch/oz09/ys2525/MewtwoMegaEvo/Playground/config_files.json"
